...
- If you've obtained a list of page urls, such as [front pages from issues](get-a-list-of-front-page-urls), just copy the number at the end of the url.
...
response = requests.get("https://api.trove.nla.gov.au/v3/newspaper/162833980", params=params, headers=headers)
data = response.json()
...
for issue in issues[:5]:
    ...
    image_url = f"https://trove.nla.gov.au/ndp/imageservice/nla.news-page{page_id}/level4"
